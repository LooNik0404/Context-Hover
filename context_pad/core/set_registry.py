...
class SetRegistry:
    ...
    def add_set_with_saved_order(self, name: str, ordered_members: Optional[List[str]] = None) -> bool:
        """Add set members preserving saved order first when available."""

        return maya_sets.add_set_with_saved_order(name, ordered_members=ordered_members)
